...
curl -s -k https://cms-pdmv.cern.ch/mcm/public/restapi/requests/get_fragment/HIG-RunIISummer20UL16wmLHEGEN-03620 --retry 3 --create-dirs -o Configuration/GenProduction/python/HIG-RunIISummer20UL16wmLHEGEN-03620-fragment.py
[ -s Configuration/GenProduction/python/HIG-RunIISummer20UL16wmLHEGEN-03620-fragment.py ] || exit $?;
scram b
cd ../..
